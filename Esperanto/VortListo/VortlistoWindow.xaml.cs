...
namespace Esperanto.Traduko;

public partial class VortlistoWindow 
{
    ...
    private ComboBoxHelper ComboBoxHelper { get; set; } =
        new(@"C:\Users\Jarek\RiderProjects\Esperanto\Esperanto\Resources\Vortlisto");


    public VortlistoWindow()
    {
        InitializeComponent();
        DataContext = this;
        ...
        _csvDataList = _dataHelper.ReadCsv(ComboBoxHelper.GetCorrectPath("Lesson0", ".csv"),
